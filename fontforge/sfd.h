...
extern int SFDWriteBak(char *filename, SplineFont *sf, EncMap *map, int compacted);
extern int SFDWriteBakExtended(char* locfilename, SplineFont *sf, EncMap *map, int compacted, int s2d, int localPrefMaxBackupsToKeep);
...
extern int SFDWrite(char *filename,SplineFont *sf,EncMap *map,int compacted, int todir);
